...
function () {
  ...
  _createClass(Draggable, [{
    ...
    value: function initEvents(el) {
      ...
      var windowListenGuard = function windowListenGuard(type, listener) {
      ...
      this.onDestroy = [windowListenGuard('pointermove', this.move.bind(this)), windowListenGuard('pointerup', this.up.bind(this))];
    }
  }, {
    key: "getCoords",
    ...
    value: function destroy() {
      this.onDestroy.forEach(function (cb) {
        return cb();
      });
    }
  }]);
